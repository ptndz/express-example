...
function JwtSignAccessToken(payload: string | Buffer | object, exp: number): Promise<FunSign> {
	try {
...
function JwtSignRefreshToken(payload: string | Buffer | object, exp: number): Promise<FunSign> {
...
async function JwtGenerateTokens(payload: string | Buffer | object): Promise<FunGenerateTokens> {
	try {
